...
const AppHeader = () => {
  ...
  <div
    className="absolute top-full z-50 mt-1 w-[450px] rounded-md bg-white py-2 shadow-lg ring-1 ring-black ring-opacity-5 grid grid-cols-2 gap-4"
    style={{
      left: 'auto',
      right: 0, // Ensures the dropdown aligns to the right of the parent container if it overflows
    }}
  >
